export const items = [
  {
    ...
    price: 986,
    otherImgs: [
      "../img/products/otherProducts/other1.jpg",
      "../img/products/otherProducts/other2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 45,
    otherImgs: [
      "../img/products/otherProducts/toster1.jpg",
      "../img/products/otherProducts/toster2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 79,
    otherImgs: [
      "../img/products/otherProducts/lampblue1.webp",
      "../img/products/otherProducts/lampblue2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 254,
    otherImgs: [
      "../img/products/otherProducts/pulpunit1.jpg",
      "../img/products/otherProducts/pulpunit2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 189,
    otherImgs: [
      "../img/products/otherProducts/moderngold1.webp",
      "../img/products/otherProducts/moderngold2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 67,
    otherImgs: [
      "../img/products/otherProducts/cleaningoil1.jpg",
      "../img/products/otherProducts/cleaningoil2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 220,
    otherImgs: [
      "../img/products/otherProducts/blackandwhite1.webp",
      "../img/products/otherProducts/blackandwhite2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 115,
    otherImgs: [
      "../img/products/otherProducts/shelf1.webp",
      "../img/products/otherProducts/shelf2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 161,
    otherImgs: [
      "../img/products/otherProducts/vase1.webp",
      "../img/products/otherProducts/vase2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 89,
    otherImgs: [
      "../img/products/otherProducts/chairboom1.webp",
      "../img/products/otherProducts/chairboom1.webp",
    ],
    description: "Traditional Armchair",
    price: 89,
    ...
    specs:
      "&Tradition's Boomerang lounge chair is a classic Danish design with a modern and minimalist expression. The chair was designed by Hvidt & Mølgaard in 1956, and with its stylish cushions and hand-polished wooden frame, it is an ideal Nordic design that gives a personal mark to the home.",
    texture: "Wood",
    weight: "8kg",
    size: "60cm x 40cm",
  },
  {
    ...
    price: 160,
    otherImgs: [
      "../img/products/otherProducts/blacklamp1.webp",
      "../img/products/otherProducts/blacklamp2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 220,
    otherImgs: [
      "../img/products/otherProducts/goldenlamp1.webp",
      "../img/products/otherProducts/goldenlamp2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 33,
    otherImgs: [
      "../img/products/otherProducts/cotton1.jpg",
      "../img/products/otherProducts/cotton2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 520,
    otherImgs: [
      "../img/products/otherProducts/woodchair1.webp",
      "../img/products/otherProducts/woodchair2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 330,
    otherImgs: [
      "../img/products/otherProducts/copenhagen1.webp",
      "../img/products/otherProducts/copenhagen2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 120,
    otherImgs: [
      "../img/products/otherProducts/cam1.webp",
      "../img/products/otherProducts/cam2.jpg",
    ],
    specs:
  ...
  },
  {
    ...
    price: 75,
    otherImgs: [
      "../img/products/otherProducts/tablelamp1.webp",
      "../img/products/otherProducts/tablelamp2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 175,
    otherImgs: [
      "../img/products/otherProducts/mat1.webp",
      "../img/products/otherProducts/mat2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 119,
    otherImgs: [
      "../img/products/otherProducts/comfy1.webp",
      "../img/products/otherProducts/comfy2.webp",
    ],
    specs:
  ...
  },
  {
    ...
    price: 45,
    otherImgs: [
      "../img/products/otherProducts/bodyoil1.jpg",
      "../img/products/otherProducts/bodyoil2.jpg",
    ],
    specs:
      "Made from 100% plant-based oils with olive oil as the main ingredient, this cleansing oil is gentle on the skin. Free from fragrance, colors, and mineral oils, paraben-free, alcohol-free, allergy tested (we cannot guarantee that it will not cause allergies in any users) * How to use: Take a small amount in the palm of your hand and massage into the face to remove makeup and dirt. Rinse well with cold or warm water.",
    texture: "Liquid",
    weight: "50ml",
    size: "10cm x 5cm",
  },
